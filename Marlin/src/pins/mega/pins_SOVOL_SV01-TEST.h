...
/**
 * SOVOL SV01 pin assignments
 */

#include "env_validate.h"

#define BOARD_INFO_NAME      "SOVOL SV01"
#define DEFAULT_MACHINE_NAME "SV01"
#define BOARD_WEBSITE_URL    "tinyurl.com/wrxrwfh"
